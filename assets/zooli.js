...
(function () {
  ...
  function reply(text) {
    ...
    return 'אפשר לשאול אותי "מאיפה המחירים?", "כמה עולה חלב", או פשוט לכתוב "נגמר החלב" ואני אוסיף לרשימה.';
  }
  ...
  function reel() {
    ...
    function render(i) {
      ...
      if (REDUCED) {                       /* בלי הנפשה — הכול בבת אחת */
    ...
    function onScroll() {
      ...
      pending = setTimeout(function () { render(nearest()); }, 130);
    }
